...
namespace SampleWebApp.Controllers
{
    public class JokesController : ControllerBase
    {
        ...
        {
            return Task.FromResult<IActionResult>(_context.Joke != null ?
                        View() :
                        Problem("Entity set 'ApplicationDbContext.Joke'  is null."));
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,JokeQuestion,Answer")] Joke joke)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,JokeQuestion,Answer")] Joke joke)
        {
            if (id != joke.Id)
            {
                return NotFound();
